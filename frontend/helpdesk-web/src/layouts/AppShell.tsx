...
import {
  ...
  Users, Building2, Tags, Gauge, BarChart3, Activity, Settings, Plus, Command, Wifi, WifiOff, Loader,
} from 'lucide-react';
      ...
      <div className="shell-main">
        <header className="topbar">
          ...
          <div className="top-actions">
            ...
            <Dropdown>
              <Dropdown.Toggle variant="outline-secondary" size="sm" className="icon-btn" aria-label="Account"><UserAvatar name={user?.fullName ?? 'U'} size={24} /></Dropdown.Toggle>
